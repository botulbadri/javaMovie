...
import student.tmdbmovieapp.adapter.MoviesAdapter;
import student.tmdbmovieapp.api.ApiInterface;
...
public class MainActivity extends AppCompatActivity {
    ...
    private final String BASE_URL="https://api.themoviedb.orgc";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        movieResultCall.enqueue(new Callback<MovieResult>() {
            ...
            public void onResponse(Call<MovieResult> call, Response<MovieResult> response) {
                movieResultlist.add(response.body());
